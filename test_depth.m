...
ff_train1 = fopen('Image4LSTM/test/test_depth_fullbody.txt','w');
ff_train2 = fopen('Image4LSTM/test/test_depth_full.txt','w');
...
while feof(fpn) ~= 1                %用于判断文件指针p在其所指的文件中的位置，如果到文件末，函数返回1，否则返回0  
      ...
      detectionLabel = fopen(['DATA/test_seg_Depth_DetectionLabel/Label_',file(10:16),'.txt']);
