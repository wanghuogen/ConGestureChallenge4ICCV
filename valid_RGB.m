...
fpn = fopen ('video/valid_seg_rgb.txt');           %打开文档clear,clc

ff_train1 = fopen('Image4LSTM/valid/valid_rgb_fullbody.txt','w');
ff_train2 = fopen('Image4LSTM/valid/valid_rgb_full.txt','w');
...
while feof(fpn) ~= 1                %用于判断文件指针p在其所指的文件中的位置，如果到文件末，函数返回1，否则返回0  
      ...
      detectionLabel = fopen(['DATA/valid_seg_Rgb_DetectionLabel/Label_',file(11:17),'.txt']);
